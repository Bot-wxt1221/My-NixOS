{
  ...
  outputs =
    ...
    in
    {
      ...
      nixosConfigurations.wxt-roc-rk3328-cc-image = nixpkgs.lib.nixosSystem {
        system = "aarch64-linux";
        specialArgs = SystemSpecialArgs;
        modules = [
          ./sd-image.nix
      ...
      packages.x86_64-linux.niri = niri-flake.packages."x86_64-linux".niri-unstable.overrideAttrs (old: {
